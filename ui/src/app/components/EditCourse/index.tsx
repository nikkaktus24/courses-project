        ...
        if (this.props.course) {
            return (
                <div className='cc-create-course'>
                    <div className='cc-text cc-text__h1 cc-create-course__title'>Курс успешно отредактирован (id: {this.props.course.id})</div>
            ...
            return (
                <div className='cc-create-course'>
                    <div className='cc-text cc-text__h1 cc-create-course__title'>Редактирование курса</div>
